...
export function ToolWidgetShell({ children, title }: ToolWidgetShellProps) {
  return (
    <div className="bg-surface border border-overlay/10 rounded-card p-6 md:p-8 w-full max-w-4xl mx-auto my-8">
      {title && (
      ...
      {children ? (
        ...
        <div className="border-2 border-dashed border-overlay/20 rounded-lg p-12 flex flex-col items-center justify-center text-center bg-background/50 h-[300px] tool-interaction-zone">
