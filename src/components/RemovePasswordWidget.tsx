    ...
    <ToolWidgetShell>
            ...
            <div className="bg-paper rounded-lg border border-ink/10 p-4 sm:p-6">
              ...
              <div className="mt-8 space-y-4 max-w-md mx-auto">
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-grey mb-2">Original Password</label>
      ...
      {isProcessing && (
        <div className="flex flex-col items-center justify-center p-12">
          ...
          <p className="text-ink font-medium">Unlocking PDF... (this may take a moment)</p>
        </div>
      )}
