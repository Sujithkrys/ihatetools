      ...
      <div className="bg-paper rounded-lg border border-ink/10 overflow-hidden flex flex-col shadow-hard">
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-center px-4 py-4 border-b border-ink/10 bg-white/[0.02] gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleClear}
              className="px-4 py-1.5 bg-ink/5 hover:bg-overlay/10 text-ink rounded font-medium text-sm transition-colors"
            >
              Clear
            </button>
            <button
        ...
        {!hasCompared ? (
          <div className="flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-white/5">
            <div className="flex-1 flex flex-col">
              <div className="px-4 py-2 bg-black/10 border-b border-ink/10 text-xs font-medium text-grey uppercase tracking-wider">
                Original Text
              </div>
              <textarea
                value={text1}
                ...
                className="w-full min-h-[400px] p-4 bg-transparent text-ink focus:outline-none resize-y font-mono text-sm leading-relaxed"
                spellCheck={false}
              />
            </div>
            <div className="flex-1 flex flex-col">
          ...
          <div className="flex flex-col min-h-[400px]">
            <div className="flex items-center justify-between px-4 py-2 bg-black/10 border-b border-ink/10">
              <span className="text-xs font-medium text-grey uppercase tracking-wider">
                Diff Result (Inline)
              </span>
              <button 
