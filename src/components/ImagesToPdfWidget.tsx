    ...
    <ToolWidgetShell>
      {!downloadUrl && !isProcessing && (
        <div className="space-y-6">
          ...
          {files.length > 0 && (
            <div className="animate-reveal-result bg-paper rounded-lg border border-ink/10 p-4 sm:p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-yellow text-background rounded-md hover:bg-yellow/90 transition-colors font-medium text-sm"
                  >
                    Generate PDF
                  </button>
                </div>
