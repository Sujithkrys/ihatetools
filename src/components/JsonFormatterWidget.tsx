      ...
      <div className="bg-paper rounded-lg border border-ink/10 overflow-hidden flex flex-col">
        ...
        <div className="relative">
          <textarea
            ...
            className={cn(
              "w-full min-h-[400px] p-4 sm:p-6 bg-transparent text-ink focus:outline-none resize-y code-mono text-sm leading-relaxed whitespace-pre",
          ...
          {errorMsg && (
            <div className="absolute bottom-4 left-4 right-4 bg-error/10 border border-error/50 rounded-md p-3 flex items-start gap-2">
              ...
              <p className="text-sm text-error code-mono break-words">{errorMsg}</p>
            </div>
          )}
        </div>
      </div>
