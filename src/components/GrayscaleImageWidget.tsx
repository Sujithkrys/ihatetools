          ...
          >
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="p-4 rounded-full bg-paper">
                <Paintbrush className="w-8 h-8 text-grey" />
              </div>
              <div>
                <p className="text-lg font-medium text-ink">Drag & drop your Image here</p>
                <p className="text-sm text-grey mt-1">to apply a grayscale filter</p>
              </div>
      ...
      {file && (
        <div className="animate-reveal-result bg-paper rounded-lg border border-ink/10 p-4 sm:p-6 space-y-8">
          ...
          <div className="flex flex-col items-center space-y-6">
            <div className="relative w-full max-w-md aspect-video bg-bg border border-ink/15 rounded-lg flex items-center justify-center overflow-hidden">
